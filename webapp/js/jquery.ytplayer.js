...
( function( jQuery, ytp ) {
    ...
    jQuery.mbYTPlayer = {
        ...
        defaults: {
            ...
            onReady: function( player ) {  jQuery( player ).hide(); }
        },
        /* @fontface icons */
        controls: {
            play: "P",
        ...
        buildControls: function( YTPlayer ) {
            ...
            var progressBar = jQuery( "<div/>" ).addClass( "mb_YTPProgress" ).css( "position", "absolute" ).click( function( e ) {
                ...
                var totalTime = Math.floor( YTPlayer.player.getDuration() );
                YTPlayer.moveto = ( timeBar.outerWidth() * totalTime ) / progressBar.outerWidth();
                YTPlayer.player.seekTo( parseFloat( YTPlayer.moveto ), true );
                YTPlayer.controlBar.find( ".mb_YTPLoaded" ).css( {
                    width: 0
                } );
            } );
