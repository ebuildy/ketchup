...
$data[0]['description'] = "One week ago, I played Zelda: Breath of the Wild and thought it was Nintendo's most ambitious game in years. It was the first game I played at this year's E3...";
...
$data[1]['description'] = "United were interested in Hummels in 2014 but he stayed at Borussia Dortmund for two more years before joining Bayern last month";
...
$data[2]['description'] = "Samsung and Apple are quickly being challenged by up-and-coming Asian smartphone manufacturers and one of them is OnePlus. Recently, the company brought out its flagship OnePlus 3 device...";
...
$data[4]['description'] = "Users will receive a free update to WatchOS 3 this fall, which is essentially a wholesale redesign of the Apple Watch interface";
...
$data[5]['description'] = "Docker, which is hosting its sold-out developer conference in Seattle this week, today announced a major addition to its core Docker Engine";
...
$data[7]['description'] = "Transforming a hackaday project into the backbone of how journalists work in a data driven organisation";
...
$data[9]['description'] = "Après une version Junior spécialement adaptée aux enfants de 6 à 12 ans, le moteur de recherche « européen » vient de lancer Qwant Music";
